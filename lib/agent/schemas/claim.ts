...
export const SourceSchema = z.object({
  ...
  credibility: z
    ...
    .max(1)
    .optional()
    .describe('Credibility score 0-1 (LLM + deterministic)'),
  relevance: z
    .number()
    .min(0)
    .max(1)
...
export const EvidenceSchema = z.object({
  ...
  location: z
    .string()
    .optional()
    .describe("Location in source, e.g. 'p.2' or 'chars 102-340'"),
})
...
export const ClaimSchema = z.object({
  ...
  evidenceIds: z
    .array(z.uuid())
    .min(1)
    .describe('References Evidence.evidenceId[] — must be non-empty'),
